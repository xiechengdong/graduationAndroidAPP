...
public class Message_detailsAdapter extends BaseAdapter {

    private Context context;
    private List<Message_details> messages;

    public Message_detailsAdapter(Context context, List<Message_details> messages) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //获取数据值
        Message_details message = messages.get(position);
