...
public class Book_Show_All_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show__all_book);

        sharedPreferences = this.getSharedPreferences("userInfo", Context.MODE_PRIVATE);
        show_book = findViewById(R.id.book_show_all_lv);
        searchContent = findViewById(R.id.book_show_all_searchContent);
        //显示所有的书籍
        showAllBook();
    ...
    class ItemClickEvent implements AdapterView.OnItemClickListener{
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            if(Pattern.matches(ConfigCenter.regex3,sharedPreferences.getString("number",null))){
                //教师点击
                Intent intent = new Intent(Book_Show_All_Activity.this, Book_Show_details_Activity.class);
                intent.putExtra("book",book);
                intent.putExtra("flag","0");
                startActivity(intent);
            }else {
                //学生点击
                Intent intent = new Intent(Book_Show_All_Activity.this,Student_Book_Show_Details_Activity.class);
                intent.putExtra("book",book);
                intent.putExtra("flag","0");
                startActivity(intent);
            }
